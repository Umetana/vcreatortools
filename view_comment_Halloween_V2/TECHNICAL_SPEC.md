# View Comment Halloween V2 技術基盤メモ

本ドキュメントは、派生元 `custom_base_template_V2_8_dev` の内部構造、VCT SDK V2対応、画面内設定パネルの仕様を引き継いだ技術メモです。ハロウィン版の確定仕様と実装範囲は `SPEC.md` を正とします。
