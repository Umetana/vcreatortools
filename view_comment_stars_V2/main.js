...
createApp({
  setup() {
    ...
    const buildStars = (comment) => {
      ...
      const count = C.STAR_COUNT || 12;
      const sizeMin = C.STAR_SIZE_MIN || 14;
      const sizeMax = C.STAR_SIZE_MAX || 28;
      const durationMin = C.STAR_DURATION_MIN || 1.8;
      const durationMax = C.STAR_DURATION_MAX || 3.2;
      const delayMax = C.STAR_DELAY_MAX || 0.7;
